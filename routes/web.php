...
Route::get('alumnos/{alumnos}/editar', 'AlumnoController@editar');
...
Route::put('profesor/{profesor}', 'ProfesorController@actualizar');
...
Route::group(['middleware' => ['permission:view_notas']], function () {
    Route::resource('notas', 'NotaxController');
});
