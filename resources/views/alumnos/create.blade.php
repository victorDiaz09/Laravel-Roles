...
@section('content')
    <section class="content-header">
        <center>
            <h1 class="text-primary p-5">Crear un nuevo usuario </h1>
            <form method="POST" action="{{ url('alumnos/crear') }}">
                @csrf
                
            <div class="form-floating mb-3">
                <label for="floatingInput" class="col-sm-3 col-form-label">Name: </label>
            ...
            <div class="form-floating mb-3">
                <label for="floatingInput" class="col-sm-3 col-form-label">Email:</label>
                <div class="form-group col-sm-6">
            ...
            <div class="form-floating mb-3">
                <label for="floatingInput" class="col-sm-3 col-form-label">Clave:</label>
                <div class="form-group col-sm-6">
